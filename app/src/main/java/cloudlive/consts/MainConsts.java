package cloudlive.consts;


public class MainConsts {
    //    private static final String LIVE_LOGIN = "http://demo.talk-fun.com/login.php?key=%s&nickname=%s"; //直播登录接口
    private static final String LIVE_LOGIN = "http://open.talk-fun.com/live/mobile/login.php?id=%s&password=%s&nickname=%s&mode=%s"; //直播登录接口
    //    private static final String PLAY_BACK_LOGIN = "http://demo.talk-fun.com/api/playback.php?liveid=%s";//点播登录接口
    private static final String PLAY_BACK_LOGIN = "http://open.talk-fun.com/playback/mobile/login.php?id=%s&password=%s&mode=%s";//点播登录接口
